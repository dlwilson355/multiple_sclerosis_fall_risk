...
def create_generators():
        training_generator = MatrixDataGenerator(directory = data_filepath, matrix_dimensions = (224, 224), rgb = True, batch_size = 32, grab_data_from = (0, .75), preload_concatenated_dataframes = True, preload_activity_start_and_end_indicies = True, print_loading_progress = False, debug = False)
        validation_generator = MatrixDataGenerator(directory = data_filepath, matrix_dimensions = (224, 224), rgb = True, batch_size = 32, grab_data_from = (.75, 1), preload_concatenated_dataframes = True, preload_activity_start_and_end_indicies = True, print_loading_progress = False, debug = False)
