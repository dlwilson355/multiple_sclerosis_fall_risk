...
def create_generators():
        ...
        preLoader = MatrixPreLoader(dataset_directory = data_filepath, num_patients_to_use = "ALL", activity_types = activities_to_load, print_loading_progress = False)
        ...
        validation_generator = MatrixDataGenerator(preLoader, matrix_dimensions = (224, 224), rgb = True, twoD = False, add_gaussian_noise = 0, zero_sensors = 0, batch_size = 100, grab_data_from = (.75, 1), overflow = "AFTER", print_loading_progress = True)
